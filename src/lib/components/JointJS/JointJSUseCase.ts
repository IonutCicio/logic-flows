import { type IUMLUseCase, type UMLAttribute, type UMLOperation } from '$lib/types/uml';
...
export const JointJSUseCase = joint.dia.Element.define(
    'custom.JointJSUseCase',
    {
        name: 'UseCase',
        attributes: [],
        operations: [],
    ...
    },
    {
        ...
        initialize: function(this: IUMLUseCase) {
        ...
        update: function(this: IUMLUseCase) {
