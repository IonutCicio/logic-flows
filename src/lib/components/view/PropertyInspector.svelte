...
<div class="p-4">
    ...
    {#if cellViews.length == 1 && cellViews[0].model instanceof JointJSClass}
        <ClassInspector component={cellViews[0].model} />
    {:else if cellViews.length == 1 && cellViews[0].model instanceof JointJSAssociation}
        <AssociationInspector component={cellViews[0].model} />
    {:else if cellViews.length == 1 && cellViews[0].model instanceof JointJSGeneralization}
